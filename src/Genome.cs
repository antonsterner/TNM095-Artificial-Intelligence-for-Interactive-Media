    ...
    public class Genome : MonoBehaviour
    {
        ...
        public Genome(Genome toBeCopied)
        {
            ...
            foreach (int index in toBeCopied.Connections.Keys)
            {
                ...
                Connections[index].Weight = RandomWeight(); // set random weights for each new copy 
            }
        }
        /**
        ...
        public static float CompatibilityDistance(Genome genome1, Genome genome2, float c1, float c2, float c3)
        {
            ...
            for (int i = 0; i <= indicesNode; i++) // loop through genes -> i is innovation numbers
            {                   
            ...
            for (int i = 0; i <= indicesCon; i++) // loop through genes -> i is innovation numbers
            {                   
            ...
            float N = 1; // number of genes in largest parent, set to 1 if less than 20 genes
